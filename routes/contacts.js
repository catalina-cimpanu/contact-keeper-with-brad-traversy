// CRUD function for the contacts of a user
...
router.post(
  "/",
  [auth, [check("name", "Name is required").not().isEmpty()]], //if you want to put several middlewares, you put them in []
  async (req, res) => {
...
router.delete("/:id", auth, async (req, res) => {
  try {
    ...
    // from mongoose https://mongoosejs.com/docs/api/model.html#model_Model.findByIdAndUpdate
    // don't use delete cuz is deprecated
